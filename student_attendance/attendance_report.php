...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header"><b>LAPORAN KEHADIRAN</b></div>
			<div class="card-body">
				<form id="manage-attendance">
					<input type="hidden" name="id" value="">
					<div class="row justify-content-center">
						<label for="" class="mt-2">JADWAL PELAJARAN</label>
						<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-md-12" id='att-list'>
							<center><b><h4><i>PILIH KELAS</i></h4></b></center>
						</div>
...
<div id="table_clone" style="display: none">
	<table width="100%">
		<tr>
			<td width="50%">
				<p>JURUSAN: <b class="course"></b></p>
				<p>MATERI: <b class="subject"></b></p>
				<p>TOTAL HARI: <b class="noc"></b></p>
			</td>
			<td width="50%">
				<p>KELAS: <b class="class"></b></p>
...
<div id="chk_clone" style="display: none">
	<div class="d-flex justify-content-center chk-opts">
		...
		<div class="form-check form-check-inline">
		  ...
		  <label class="form-check-label absent-lbl">Tidak Hadir</label>
		</div>
		<div class="form-check form-check-inline">
