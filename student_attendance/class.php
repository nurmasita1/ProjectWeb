			...
			<form action="" id="manage-class">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label"><br>Keterangan Kelas</label>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$class = $conn->query("SELECT c.*,concat(c.section,' ',co.course,' ',c.level,'') as `class` FROM `class` c inner join courses co on co.id = c.course_id order by concat(c.section,' ',co.course,' ',c.level,'') asc");
